...
TEST(grankHeaderOnly, badParameters)
{
...
TEST(grankHeaderOnly, emptyGraph)
{
  unordered_map<int, vector<int>> graph;
...
TEST(grankHeaderOnly, testNoEdges)
{
  unordered_map<int, vector<int>> graph;
  for(int i = 0; i < 10; i++)
    graph[i];
...
TEST(grankHeaderOnly, singleNode)
{
  unordered_map<int, vector<int>> graph;
  graph[0];
  auto res =  grank(graph, 10, 30, 100, 0.85, 0.0001);
...
TEST(grankHeaderOnly, lineGraph)
{
  unordered_map<int, vector<int>> graph;
  for(int i = 0; i < 6; i++)
    graph[i];
...
TEST(grankHeaderOnly, starGraph)
{
  unordered_map<int, vector<int>> graph;
  for(int i = 0; i < 6; i++)
    graph[i];
...
TEST(grankHeaderOnly, testNodesGreaterThanK)
{
  const size_t K = 10;
  unordered_map<int, vector<int>> graph;
  for(int i = 0; i < 100; i++)
...
TEST(grankHeaderOnly, testNodesEqualK)
{
  unordered_map<int, vector<int>> graph;
  for(int i = 0; i < 100; i++)
    graph[i];
...
TEST(grankHeaderOnly, testNodesLowerThanK)
{
  unordered_map<int, vector<int>> graph;
  for(int i = 0; i < 100; i++)
    graph[i];
...
TEST(grankHeaderOnly, sameAsPagerank1)
{
  unordered_map<int, vector<int>> graph;
  for(int i = 0; i < 100; i++)
    graph[i];
...
TEST(grankHeaderOnly, sameAsPagerank2)
{
  unordered_map<int, vector<int>> graph;
  for(int i = 0; i < 100; i++)
    graph[i];
...
TEST(grankHeaderOnly, sameAsPagerank3)
{
  unordered_map<int, vector<int>> graph;
  int n = 100;
  int edges = 5000;
...
TEST(grankHeaderOnly, sameAsPagerank4)
{
  unordered_map<int, vector<int>> graph;
  int n = 100;
  for(int i = 0; i < n; i++)
